...
class TileVisuRoomHeader extends IPSModule
{
                ...
                switch ($Message)
                {
                    case VM_UPDATE:
                        ...
                        //Icon und Farbe abrufen
                            ...
                            $result[$VariableProperty .'Asso'] = GetValueFormatted($this->ReadPropertyInteger($VariableProperty));
    ...
    private function GetFullUpdateMessage() {
        ...
        if (IPS_VariableExists($this->ReadPropertyInteger('Schalter3'))) {
            ...
            if ($this->ReadPropertyBoolean('Schalter3NameSwitch')) $result['schalter3Nname'] = IPS_GetName($this->ReadPropertyInteger('Schalter3')) . ':';
