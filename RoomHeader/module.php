...
class TileVisuRoomHeader extends IPSModule
{
    ...
    public function ApplyChanges()
    {
        ...
        foreach (['bgImage', 'Variable', 'Schalter1', 'Schalter2', 'Schalter3', 'Schalter4', 'Schalter5'] as $VariableProperty)        {
    ...
    public function MessageSink($TimeStamp, $SenderID, $Message, $Data)
    {
        ...
        foreach (['bgImage', 'Variable', 'Schalter1', 'Schalter2', 'Schalter3', 'Schalter4', 'Schalter5'] as $index => $VariableProperty)
        {
            if ($SenderID === $this->ReadPropertyInteger($VariableProperty))
            {
                ...
                switch ($Message)
                {
                    case VM_UPDATE:
                        ...
                        if ($VariableProperty == "Schalter1" || $VariableProperty == "Schalter2" || $VariableProperty == "Schalter3" || $VariableProperty == "Schalter4" || $VariableProperty == "Schalter5" || $VariableProperty == "Variable")
                        {
    ...
    private function GetFullUpdateMessage() {
        $result = [
            ...
            'icon_links' => $this->ReadPropertyString('Icon_links'),
        ...
        if ($profile && IPS_VariableProfileExists($profile)) {
            ...
            foreach ($p['Associations'] as $association) {
                if (isset($association['Value'], $association['Icon']) && $association['Value'] == $Value) {
                    ...
                    $icon .= base64_encode(file_get_contents(__DIR__ . '../../legacy/img/icons/Aircraft.svg'));
